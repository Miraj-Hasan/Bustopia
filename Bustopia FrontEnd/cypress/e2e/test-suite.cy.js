...
describe('Bustopia Frontend E2E Test Suite', () => {
  ...
  describe('4. Complete User Journey', () => {
  ...
  describe('5. Navigation & Routing Tests', () => {
    beforeEach(() => {
      cy.clearAllStorage()
      cy.login()
      cy.visit('/')
  ...
  describe('6. Ticket Verification Tests', () => {
    beforeEach(() => {
      cy.clearAllStorage()
      cy.login()
    ...
    it('should validate ticket code field when company is not selected', () => {
      ...
      cy.get('input[placeholder="Enter ticket code"]').type('TKT-2619-20250708-14B3A05B7A')
      cy.get('button').contains('Verify').click()
    ...
    it('should validate company selection when ticket code is empty', () => {
      ...
      cy.get('select').select('Desh Travels')
      cy.get('button').contains('Verify').click()
    ...
    it('should verify a valid ticket successfully', () => {
      ...
      cy.get('input[placeholder="Enter ticket code"]').should('have.value', 'TKT-2619-20250708-14B3A05B7A')
      cy.get('select').should('have.value', 'Desh Travels')
  ...
  // Test 8: Forgot Password Tests
  describe('8. Forgot Password Tests', () => {
    beforeEach(() => {
      cy.clearAllStorage()
  ...
  // Test 9. Review Page Tests
  describe('9. Review Page Tests', () => {
    beforeEach(() => {
      cy.clearAllStorage()
      cy.login()
      cy.visit('/review')
  ...
  describe('10. Logout Functionality', () => {
